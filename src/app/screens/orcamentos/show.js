...
const Conteudo = (props) => {
  ...
  const copy = () => {
    ...
    setAlertMensag('')
    Clipboard.setString('Código : ' + orcamentos.data.CODIGO + 
    '\n\nCliente : ' +  orcamentos.data.cliente.NOME + ' ' + orcamentos.data.cliente.APELIDO + 
    '\n\nData : ' + orcamentos.data.DATA +
    '\n\nObs : ' + orcamentos.data.OBS + 
    '\n\nSubTotal : ' + orcamentos.data.SUBTOTAL + 
    '\n\nDesconto : ' + orcamentos.data.DESCONTO + 
    '\n\nAcrescimo : ' + orcamentos.data.ACRESCIMO +		
    '\n\nTotal : ' + orcamentos.data.TOTAL ) 
    setAlertCopy(true)
...
return (
    ...
    <TouchableOpacity onPress={() => copyItem(['Código', orcamentos.data.CODIGO])}>
    <DataLab style={{color: appInfo.cor_principal }}> Código: <DataReplyLab style={{color: appInfo.cor_segundaria }}> {orcamentos.data.CODIGO} </DataReplyLab> </DataLab>
    </TouchableOpacity>

    <TouchableOpacity onPress={() => copyItem(['Cliente', orcamentos.data.cliente.NOME + ' ' + orcamentos.data.cliente.APELIDO])}>
    <DataLab style={{color: appInfo.cor_principal }}> Cliente: <DataReplyLab style={{color: appInfo.cor_segundaria }}> {orcamentos.data.cliente.NOME} {orcamentos.data.cliente.APELIDO} </DataReplyLab> </DataLab>
    </TouchableOpacity>

    <TouchableOpacity onPress={() => copyItem(['Data', orcamentos.data.DATA])}>
    <DataLab style={{color: appInfo.cor_principal }}> Data: <DataReplyLab style={{color: appInfo.cor_segundaria }}> {orcamentos.data.DATA} </DataReplyLab> </DataLab>
    </TouchableOpacity>

    {orcamentos.data.OBS == null || orcamentos.data.OBS == ""? null :
    <TouchableOpacity onPress={() => copyItem(['Obs', orcamentos.data.OBS])}>
    <DataLab style={{color: appInfo.cor_principal }}> Obs: <DataReplyLab style={{color: appInfo.cor_segundaria }}> {orcamentos.data.OBS} </DataReplyLab> </DataLab>
    </TouchableOpacity> }

    <TouchableOpacity onPress={() => copyItem(['Subtotal', orcamentos.data.SUBTOTAL])}>
    <DataLab style={{color: appInfo.cor_principal }}> Subtotal: <DataReplyLab style={{color: appInfo.cor_segundaria }}> R$ {orcamentos.data.SUBTOTAL} </DataReplyLab> </DataLab>
    </TouchableOpacity>

    <TouchableOpacity onPress={() => copyItem(['Desconto', orcamentos.data.DESCONTO])}>
    <DataLab style={{color: appInfo.cor_principal }}> Desconto: <DataReplyLab style={{color: appInfo.cor_segundaria }}> R$ -{orcamentos.data.DESCONTO} </DataReplyLab> </DataLab>
    </TouchableOpacity>

    <TouchableOpacity onPress={() => copyItem(['Acrescimo', orcamentos.data.ACRESCIMO])}>
    <DataLab style={{color: appInfo.cor_principal }}> Acrescimo: <DataReplyLab style={{color: appInfo.cor_segundaria }}> R$ +{orcamentos.data.ACRESCIMO} </DataReplyLab> </DataLab>
    </TouchableOpacity>

    <TouchableOpacity onPress={() => copyItem(['Total', orcamentos.data.TOTAL])}>
    <DataLab style={{color: appInfo.cor_principal }}> Total: <DataReplyLab style={{color: appInfo.cor_segundaria }}> R$ {orcamentos.data.TOTAL} </DataReplyLab> </DataLab>
    </TouchableOpacity>
    ...
    <DataLab style={{color: appInfo.cor_principal }}> Conteudo do Orçamento </DataLab>
    <SetSelect>
  ...
  { viewProds == true? <CartContent>
    ...
    <FlashList
        ...
        data={orcamentos.data.orcamentos} 
